...
\begin{homeworkProblem}[3]
    ...
    \begin{homeworkSubsection}{(b)}
        ...
        \[
            ...
            \end{pmatrix}
        \]
        observe that the gradient can be arbitarily large towards infinity,
        thus there does not exist an upper bound for the gradient.

        {
            \color{red}
            From the Lipschitz condition 
            $||\nabla f(x) - \nabla f(y)|| \leq L||x - y|| \Rightarrow \frac{||\nabla f(x) - \nabla f(y)||}{||x - y||} \leq L$
            we should show $\exists x, y$ such that $\frac{||\nabla f(x) - \nabla f(y)||}{||x - y||}$ is unbounded,
            intead of showing that the gradient is unbounded.
            ...
            \]
            \[
                ||\nabla f(x) - \nabla f(y)|| = \left|\left|\begin{pmatrix}
                    2t + 4bt^3\\
                    -2bt^2
            ...
            thus
            \[
                \lim_{t\to\infty} \frac{||\nabla f(x) - \nabla f(y)||}{||x - y||} = \lim_{t\to\infty} 2bt \to \infty
            \]
        }
    \end{homeworkSubsection}
