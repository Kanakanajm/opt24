...
\begin{homeworkProblem}[2]
    ...
    \begin{homeworkProblem}[3]
        ...
        \]
        Given $\bar{x} := \begin{pmatrix}
            \bar{x}_1 \\ \bar{x}_2
        \end{pmatrix}$ s.t. $4\bar{x}_1(6\bar{x}_2^2 + 1) > (6\bar{x}_2 + 2)(12\bar{x}_1^3 + 1)$,
        we want to find $N_C(\bar{x})$.

        The question we should ask is whether $\bar{x} \in C$
        and if so,
        does the result of transformation $F(\bar{x})$ lies on the boundary of the unit circle
        or it is in the interior of the unit circle?

        Take the point $\bar{x} = \begin{pmatrix}
            1 \\ -1
        \end{pmatrix}$ as an example. One can verify that $\bar{x}$ satisfies the inequality condition
        but it is not in $C$ because the $F(\bar{x}) = \begin{pmatrix}
            2 \\ 1
        \end{pmatrix}$ which is not in $D$.

        \pagebreak

        Let's assume that indeed, $\bar{x} \in C$ and there will be two cases to consider:
        \begin{enumerate}[label=\roman*.]
            \item $\bar{z} = F(\bar{x})$ is in the interior of $D$
            \item $\bar{z} = F(\bar{x})$ is on the boundary of $D$
        \end{enumerate}
        ...
        \begin{homeworkSubsection}{(i) $\bar{z} = F(\bar{x})$ is in the interior of $D$}
            If $\bar{z}$ is in the interior of $D$, then the normal cone of $D$ at $\bar{z}$ is $\{0\}$.
            Thus, 
            \[
                N_C(\bar{x}) = DF(\bar{x})^T \cdot \{0\} = \{0\}
            \]
        \end{homeworkSubsection}
        \begin{homeworkSubsection}{(ii) $\bar{z} = F(\bar{x})$ is on the boundary of $D$}
            ...
            \begin{align*}
                ...
                \end{pmatrix}
            \end{align*}
            where $n \in \mathbb{R}$ and $n \geq 0$.
        \end{homeworkSubsection}
    \end{homeworkProblem}
\end{document}
