...
if run_gd: 
    ...
    options = {
        ...
        'stepsize':       0.001, # when change to 0.01, the algorithm will not converge.
        'storeResidual':  True,
        'storePoints':    True,
        'storeTime':      True
    }
...
plt.savefig('rosenbrock2d_residual.png')
...
plt.show(block=True)
plt.savefig('rosenbrock2d_contours.png')
