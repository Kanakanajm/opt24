...
\begin{homeworkProblem}[2]
    ...
    \begin{homeworkSubsection}{(iv)}
        ...
        This suggests that the Wolfe’s conditions might not be satisfied. We next check the conditions, which can be shown as
        \begin{align*}
        ...
        Thus, the Wolfe’s conditions are not satisfied.
